            ...
            <Container fluid className={"register-form align-items-center p-0 py-5 d-flex minh-100vh "+this.props.classExt}>
                <Row className="mx-auto text-start w-100 pt-5">
                    <Col xs={11} md={6} lg={5} className="mx-auto p-0 d-flex align-items-center">
                        <Form className="text-start w-100 border border-secondary p-4 rounded bg-white shadow text-muted fw-bold opacity-9 z-index-10"
                            autoComplete="off"
                            method="POST">
                            ...
                            <div className="w-100 text-start py-3">
                                <p className="text-muted fw-normal">
                                    Registered? 
                                    <Link to={this.props.backLink.href} className="text-muted fw-bold text-decoration-none">
